<template>
  <div class="footer">
    ...
    <router-link tag="div" to="/ziyushi" class="footer_li" active-class="active">
      <img v-show="route === '/ziyushi'" src="../../static/img/zys2.png" alt="">
      <img v-show="route !== '/ziyushi'" src="../../static/img/zys.png" alt="">
      <div :class="{textact:route === '/ziyushi'}">新高考</div>
      <div :class="{textact1:route !== '/ziyushi'}">新高考</div>
    </router-link>
